      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          <div class="header-logo">
            ...
            <div class="header-text">
              <h2>คำร้องขอเพิ่มที่นั่ง (RE.06)</h2>
        ...
        <div class="modal-body">
          <form @submit.prevent="submitForm">
            ...
            <div class="form-group">
              <label><i class="fas fa-level-up-alt"></i> ชั้นปี:</label>
              <input type="text" v-model="form.classLevel" placeholder="ชั้นปี" required />
            </div>
  
            <!-- Course Info -->
            <div class="form-group">
              <label><i class="fas fa-chalkboard-teacher"></i> ข้าพเจ้าประสงค์จะขอเพิ่มที่นั่งในรายวิชาดังต่อไปนี้:</label>
